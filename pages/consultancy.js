                  ...
                  <div className="inner-box">
                    ...
                    <ul className="price-options">
                      ...
                      <li>
                        ...
                        Matrix federated chat (details on account creation will
                        be provided as needed) for 90 min each session
                      </li>
                    </ul>
                  </div>
                </div>
                    ...
                    <div className="contact-form">
                      <form method="post" action="#">
                        ...
                        <small className="form-text text-muted">
                          ...
                          months, so it is suggested that you commit to no less
                          than 3 months at a time to achieve your objective
                          (e.g., bulking, cutting, recomping)
                        </small>
