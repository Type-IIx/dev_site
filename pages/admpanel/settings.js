...
export default function Settings() {
  ...
  const fetchAddress = async () => {
    const resp = await axiosInstance.get(BASE_URL + path_ + "address");
  ...
  const updateAddress = async (e) => {
    ...
    console.log(BASE_URL + path_ + "address");
    e.preventDefault();
    const body = {
      address: address.address,
    };
    const resp = await axiosInstance.post(BASE_URL + path_ + "address", body);
    if (resp.status === 200) {
      toast.success("Updated");
      fetchAddress;
    }
                  ...
                  <div class="row clearfix">
                    ...
                    <div class="mentor-block col-lg-4 col-md-6 col-sm-12">
                      <div class="inner-box">
                        <div class="lower-content">
                          <div className="sec-title-two">
                            <div className="title color-three">
                              New Password
                            </div>
                          </div>
                          <div className="form-group">
                    ...
                    <div class="mentor-block col-lg-4 col-md-6 col-sm-12">
                      <div class="inner-box">
                        <div class="lower-content">
                          <div className="sec-title-two">
                            <div className="title color-three">BTC Address</div>
                          </div>
                          <div className="form-group">
