                        ...
                        <form method="post" action="#">
                          ...
                          <div className="form-group form-check-inline">
                            <input
                              ...
                              className="form-check-input"
                            />
                            <label className="form-check-label">Research</label>
                          </div>
                          <div className="form-group form-check-inline">
                            <input
                              type="checkbox"
                          ...
                          <small className="mb-2">
                            ...
                            the proposal is accepted. Communication will follow
                            by email to [user-email], including notice of
                            rejection with modifications, or outright rejection,
                            to proposal.
                          </small>
